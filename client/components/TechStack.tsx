    ...
    <div className="w-full bg-portfolio-card/50 backdrop-blur-sm border-t border-portfolio-border py-8">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-6">
          <h3 className="text-lg font-semibold text-portfolio-text mb-2">Technologies & Tools</h3>
          <p className="text-portfolio-text-muted text-sm">Technologies I work with to bring ideas to life</p>
        </div>
            ...
            {technologies.map((tech, index) => (
              ...
              >
                ...
                <span className="text-xs text-portfolio-text-muted group-hover:text-portfolio-accent transition-colors duration-300">
                  {tech.name.length > 8 ? tech.name.slice(0, 6) + '...' : tech.name}
                </span>
              </div>
            ))}
