  ...
  const projects = [
    {
      ...
      description:
        "Modern e-commerce solution with advanced filtering and payment integration. Built with scalability and user experience in mind, featuring real-time inventory management and secure payment processing.",
    ...
    },
    {
      ...
      description:
        "Cross-platform mobile app for team collaboration and project management with real-time synchronization and offline capabilities.",
    ...
    },
    {
      ...
      description:
        "Intuitive banking interface design focused on user experience and accessibility, with modern design principles and security features.",
    ...
    },
    {
      ...
      description:
        "Complete real estate marketplace with advanced search, virtual tours, and comprehensive property management system.",
    ...
    },
    {
      ...
      description:
        "Real-time analytics dashboard with data visualization and reporting capabilities for enterprise-level data processing.",
    ...
    },
    {
      ...
      category: "Mobile Apps",
      image:
        "https://images.unsplash.com/photo-1611605698335-8b1569810432?w=600&h=400&fit=crop&auto=format&q=80",
      description:
        "Social networking platform with real-time messaging, content sharing, and advanced community features.",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-portfolio-text-muted max-w-2xl mx-auto mb-8">
            ...
            web development, mobile applications, and user interface design.
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project) => (
            ...
            >
              ...
              <div className="p-6">
                <div className="mb-2">
                  <span className="text-xs text-portfolio-accent font-medium">
                    {project.category}
                  </span>
                </div>
        ...
        <div className="text-center mt-16">
          <div className="portfolio-card p-8 max-w-2xl mx-auto">
            ...
            <p className="text-portfolio-text-muted mb-6">
              ...
              ideas to life. Let's discuss how we can collaborate on your next
              project.
            </p>
            <a
              href="/contact"
